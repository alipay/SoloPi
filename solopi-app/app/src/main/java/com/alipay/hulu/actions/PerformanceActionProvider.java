...
public class PerformanceActionProvider implements ActionProvider {
    ...
    public void onDestroy(Context context) {
        // Replay creates and destroys every ActionProvider. Do not clear a performance session
        // owned by PerformanceSchemeResolver when this provider never started that session.
        if (isRecording) {
            displayProvider.stopAllDisplay();
            isRecording = false;
        }
