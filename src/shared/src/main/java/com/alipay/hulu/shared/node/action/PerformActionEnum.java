...
public enum PerformActionEnum {
    ...
    CLICK_AND_INPUT("clickAndInput", R.string.action__click_and_input, 1, 0, R.drawable.dialog_action_drawable_click),
    ...
    KEYBOARD_INPUT("keyboardInput", R.string.action__global_keyboard_input, 2, 0, R.drawable.dialog_action_drawable_keyboard),
    INPUT_GLOBAL("inputGlobal", R.string.action__global_global_input, 3, 0, R.drawable.dialog_action_drawable_input, INPUT_PARAMS),
