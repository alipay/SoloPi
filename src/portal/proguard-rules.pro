...
-keep class com.alipay.hulu.activity.CaseReplayResultActivity$ScreenshotBean {*;}
...
-keep class com.alipay.hulu.shared.node.tree.OperationNode$ParentNode {*;}
...
-keep class com.alipay.hulu.common.injector.aidl.InjectAidlInterface { *; }
-keep class com.alipay.hulu.common.injector.aidl.InjectMessageListener { *; }
-keep class com.alipay.hulu.common.injector.bean.InjectMessage { *; }
-keep class com.alipay.hulu.shared.io.socket.LocalNetworkBroadcastService$SlaveInfo { *; }
